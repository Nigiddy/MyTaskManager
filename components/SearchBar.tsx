...
export function SearchBar() {
  ...
  const handleSearch = () => {
    ...
    toast({
      ...
      description: `Searching for "${query.trim()}" — full search will be available once the data layer is connected.`,
    });
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 px-2 py-1 rounded-md bg-white/[0.06] border border-white/[0.08] hover:bg-white/[0.10] transition-colors"
      >
