  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="h-11 w-full rounded-xl border border-white/[0.08] bg-white/[0.03] pl-11 pr-20 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#4cc9f0]/50 focus:ring-2 focus:ring-[#4cc9f0]/20 transition-all duration-300"
      />
