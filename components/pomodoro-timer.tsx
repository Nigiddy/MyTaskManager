...
export function PomodoroTimer() {
  ...
  return (
    <div
      className={`bg-[#FFF8F3] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-all duration-300 ${
    ...
    >
      ...
      <div className="text-center mb-6">
        <div
          className={`inline-flex items-center px-4 py-2 rounded-full mb-3 ${getModeColor(
            currentMode
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div className="text-center p-3 bg-white rounded-lg border border-[#FFE8D6]">
          <div className="text-2xl font-bold text-[#FF9F43]">
            {completedPomodoros}
          </div>
      ...
      {isFocusMode && (
        <div className="p-3 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg border border-red-200">
          ...
          <div className="mt-2 text-xs text-red-600">
            Notifications muted • Stay focused on your current task • Break
            timer will remind you to rest
          </div>
        </div>
      )}
      ...
      <div className="mt-4 p-3 bg-[#FFE8D6] rounded-lg">
        <div className="flex items-center justify-between text-sm">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-6 px-2 text-xs text-[#FF9F43]"
          >
