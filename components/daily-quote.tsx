...
export function DailyQuote() {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case "stoic": return "text-blue-600 bg-blue-50 border-blue-200"
      case "motivational": return "text-orange-600 bg-orange-50 border-orange-200"
    ...
    <div className="bg-gradient-to-br from-[#FFF8F3] to-[#FFE8D6] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)] border border-[#FFE8D6]">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="font-semibold text-lg text-[#333]">QUOTE OF THE DAY</h2>
        </div>
        <Button
          variant="ghost"
          size="sm"
      ...
      <div className="text-center py-4">
        <div className="flex justify-center mb-3">
          <div className={`p-2 rounded-full ${getCategoryColor(currentQuote.category)}`}>
      ...
      <div className="mt-3 flex justify-center">
        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getCategoryColor(currentQuote.category)}`}>
