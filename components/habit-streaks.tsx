...
export function HabitStreaks() {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case "Productivity": return "bg-green-100 text-green-700 border-green-200"
  ...
  return (
    <div className="bg-[#FFF8F3] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
      ...
      <div className="space-y-3">
        {habits.map((habit) => (
          <div key={habit.id} className={`p-3 rounded-lg border transition-all ${
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 text-xs">
                ...
                <div className="flex items-center text-blue-500">
                  ...
                  <span className="font-medium">Best: {habit.longestStreak}</span>
                </div>
              </div>
