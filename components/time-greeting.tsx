...
export function TimeGreeting() {
  ...
  return (
    <div
      className={`${greeting.bgColor} rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)] border ${greeting.borderColor}`}
    >
      ...
      <div className="text-center py-3">
        ...
        <div className="text-sm text-[#666] mb-3">{greeting.subtitle}</div>
        <div className="text-xs text-[#666] italic">{greeting.motivation}</div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 text-center">
        <div className="p-2 bg-white rounded-lg border border-[#FFE8D6]">
          ...
          <div className="text-sm font-semibold text-[#333] capitalize">
            {currentPeriod}
          </div>
        </div>
        <div className="p-2 bg-white rounded-lg border border-[#FFE8D6]">
