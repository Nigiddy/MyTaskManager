    ...
    <div className="bg-[#FFF8F3] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="text-right ml-4">
                  ...
                  <div className="text-sm font-bold text-[#FF9F43] mt-1">
                    {project.progress}%
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center space-x-2">
                  {project.githubUrl && (
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-6 px-2 text-xs text-[#666] hover:text-[#333]"
                    >
      ...
      <div className="p-3 bg-gradient-to-r from-[#FFE8D6] to-[#FFF1E6] rounded-lg">
        ...
        <div className="mt-2 text-xs text-[#666]">
          Complete Python data science course • Build 3 full-stack projects •
